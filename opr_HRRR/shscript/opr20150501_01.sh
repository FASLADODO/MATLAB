...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150501/hrrr.t01z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150501-0030* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150501-0040* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150501-0050* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150501-0100* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150501-0020* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150501-0030* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150501-0040* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150501-0050* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150501-0100* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150501-01
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150501-01
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150501-01
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150501-01
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
