...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150513/hrrr.t03z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150513-0230* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150513-0240* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150513-0250* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150513-0300* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150513-0220* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150513-0230* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150513-0240* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150513-0250* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150513-0300* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150513-03
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150513-03
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150513-03
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150513-03
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
