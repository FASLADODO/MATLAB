...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t15z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150504-1430* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150504-1440* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150504-1450* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150504-1500* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150504-1420* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-1430* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-1440* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-1450* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-1500* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150504-15
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150504-15
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150504-15
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150504-15
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
