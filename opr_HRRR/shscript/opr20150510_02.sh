...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t02z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150510-0130* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150510-0140* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150510-0150* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150510-0200* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150510-0120* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-0130* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-0140* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-0150* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-0200* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150510-02
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150510-02
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150510-02
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150510-02
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
