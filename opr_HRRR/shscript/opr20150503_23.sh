...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t23z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
AWORK="$HWORK/WORK"
MRMS="/raid/swat_archive/merged/20150503/multi/MergedReflectivityQCComposite/00.50"
MRMS2="/raid/swat_archive/merged/20150502/multi/MergedReflectivityQCComposite/00.50"
EMRMS="/raid/swat_archive/merged/20150503/multi/EchoTop_18/00.50"
EMRMS2="/raid/swat_archive/merged/20150502/multi/EchoTop_18/00.50"
...
cp $MRMS/20150503-2230* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150503-2240* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150503-2250* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150503-2300* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150503-2220* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2230* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2240* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2250* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2300* $HWORK/INPUT/$ETP/00.00/
...
cp $MRMS2/20150504-0100* $HWORK/INPUT/$E/00.00/
cp $MRMS2/20150504-0000* $HWORK/INPUT/$E/00.00/
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
w2cropconv -i $HWORK/INPUT/code_index.xml -I "$E" -t "51.00 -127" -b "21.00 -65.00" -s "0.03 0.03" -o "$AWORK" -R  
makeIndex.pl $AWORK code_index2.xml
...
mkdir $HWORK/TRANS/Z20150503-23
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150503-23
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150503-23
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150503-23
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
