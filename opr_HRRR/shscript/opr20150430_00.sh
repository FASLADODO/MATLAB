...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t00z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS2/20150429-2330* $HWORK/INPUT/$E/00.00/
cp $MRMS2/20150429-2340* $HWORK/INPUT/$E/00.00/
cp $MRMS2/20150429-2350* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150430-0000* $HWORK/INPUT/$E/00.00/
cp $EMRMS2/20150429-2330* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS2/20150429-2340* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS2/20150429-2350* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150430-0000* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150430-00
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150430-00
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150430-00
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150430-00
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
