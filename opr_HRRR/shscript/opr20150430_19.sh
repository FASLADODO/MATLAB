...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150430/hrrr.t19z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150430-1830* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150430-1840* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150430-1850* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150430-1900* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150430-1820* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150430-1830* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150430-1840* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150430-1850* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150430-1900* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150430-19
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150430-19
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150430-19
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150430-19
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
