...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150506/hrrr.t04z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150506-0330* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150506-0340* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150506-0350* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150506-0400* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150506-0320* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150506-0330* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150506-0340* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150506-0350* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150506-0400* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150506-04
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150506-04
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150506-04
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150506-04
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
