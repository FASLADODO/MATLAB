...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150504/hrrr.t08z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150504-0730* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150504-0740* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150504-0750* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150504-0800* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150504-0720* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-0730* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-0740* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-0750* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150504-0800* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150504-08
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150504-08
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150504-08
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150504-08
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
