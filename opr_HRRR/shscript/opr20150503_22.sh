...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150503/hrrr.t22z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150503-2130* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150503-2140* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150503-2150* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150503-2200* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150503-2120* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2130* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2140* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2150* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150503-2200* $HWORK/INPUT/$ETP/00.00/
...
cp $MRMS2/20150504--100* $HWORK/INPUT/$E/00.00/
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
w2cropconv -i $HWORK/INPUT/code_index.xml -I "$E" -t "51.00 -127" -b "21.00 -65.00" -s "0.03 0.03" -o "$AWORK" -R  
makeIndex.pl $AWORK code_index2.xml
...
mkdir $HWORK/TRANS/Z20150503-22
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150503-22
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150503-22
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150503-22
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
