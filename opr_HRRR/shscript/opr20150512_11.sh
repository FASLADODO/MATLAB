...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150512/hrrr.t11z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150512-1030* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150512-1040* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150512-1050* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150512-1100* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150512-1020* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150512-1030* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150512-1040* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150512-1050* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150512-1100* $HWORK/INPUT/$ETP/00.00/
...
cp $MRMS/20150512-1200* $HWORK/INPUT/$E/00.00/
...
mkdir $HWORK/TRANS/Z20150512-11
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150512-11
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150512-11
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150512-11
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
