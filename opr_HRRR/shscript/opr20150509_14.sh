...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150509/hrrr.t14z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150509-1330* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150509-1340* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150509-1350* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150509-1400* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150509-1320* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150509-1330* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150509-1340* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150509-1350* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150509-1400* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150509-14
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150509-14
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150509-14
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150509-14
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
