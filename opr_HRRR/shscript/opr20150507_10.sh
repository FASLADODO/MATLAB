...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150507/hrrr.t10z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150507-0930* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150507-0940* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150507-0950* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150507-1000* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150507-0920* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150507-0930* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150507-0940* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150507-0950* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150507-1000* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150507-10
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150507-10
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150507-10
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150507-10
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
