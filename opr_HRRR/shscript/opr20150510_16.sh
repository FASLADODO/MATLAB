...
res1=$(date +%s.%N)
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf01.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf02.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf03.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf04.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf05.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf06.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf07.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
wget get http://www.ftp.ncep.noaa.gov/data/nccf/nonoperational/com/hrrr/prod/hrrr.20150510/hrrr.t16z.wrfsfcf08.grib2 -P /localdata2/yunsung.hwang/opr_HRRR/DOWN
...
cp $MRMS/20150510-1530* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150510-1540* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150510-1550* $HWORK/INPUT/$E/00.00/
cp $MRMS/20150510-1600* $HWORK/INPUT/$E/00.00/
cp $EMRMS/20150510-1520* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-1530* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-1540* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-1550* $HWORK/INPUT/$ETP/00.00/
cp $EMRMS/20150510-1600* $HWORK/INPUT/$ETP/00.00/
...
mkdir $HWORK/TRANS/Z20150510-16
mv $AWORK/MergedReflectivityQCComposite* $HWORK/TRANS/Z20150510-16
rm -rf $HWORK/WORK/*
/localdata2/yunsung.hwang/WDSS2/src/w2/scripts/makeIndex.pl $HWORK/INPUT code_index.xml
...
mkdir $HWORK/TRANS/E20150510-16
mv $AWORK/EchoTop_18* $HWORK/TRANS/E20150510-16
rm -rf $HWORK/INPUT/*
rm -rf $HWORK/DOWN/*
rm -rf $HWORK/WORK/*
